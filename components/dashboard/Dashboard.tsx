...
export default function Dashboard({
  ...
  const kpiCards = [
    {
      title: "Total Orders",
      todayValue: data?.totalOrders.toString() ?? "0",
      percentage: "12 %",
    ...
    },
    {
      ...
      todayValue: `₹${data?.totalRevenue ?? "0.00"}`,
      percentage: "8 %",
    ...
    },
    {
      ...
      todayValue: data?.pendingOrders.toString() ?? "0",
      percentage: "5 %",
    ...
    },
    {
      ...
      todayValue: data?.acceptedOrders.toString() ?? "0",
      percentage: "20 %",
