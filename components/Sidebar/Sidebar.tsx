...
const navbarlinks = [
	{ title: "Dashboard", icon: <DashboardIcon className="w-5 h-5 flex-shrink-0" />, href: "/dashboard" },
	{ title: "Orders", icon: <OrderIcon className="w-5 h-5 flex-shrink-0" />, badge: 5, href: "#" },
	{ title: "Marketplace", icon: <Marketplace className="w-5 h-5 flex-shrink-0" />, href: "#" },
	{ title: "Document Vault", icon: <DocumentVaultIcon className="w-5 h-5 flex-shrink-0" />, href: "#" },
	{
		title: "Services & Pricing",
		icon: <ServicesPricingIcon className="w-5 h-5 flex-shrink-0" />,
		href: "/service-pricing",
	},
	{ title: "Earnings & Wallet", icon: <EarningsWalletIcon className="w-5 h-5 flex-shrink-0" />, href: "#" },
	{ title: "Chat with customers", icon: <ChatWithCustomersIcon className="w-5 h-5 flex-shrink-0" />, href: "#" },
	{ title: "Equipments", icon: <Equipments className="w-5 h-5 flex-shrink-0" />, href: "#" },
];

export default function Sidebar() {
	return (
		<aside className="flex flex-col w-64 rounded-xl bg-white shadow-lg space-y-4 h-full">
			{/* Logo + Toggle */}
