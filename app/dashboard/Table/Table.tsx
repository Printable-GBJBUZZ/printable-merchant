...
import TablePrintButton from "@/components/TablePrintButton/TablePrintButton";
...
const Table = () => {
	if (tableData.length === 0) {
		return <div className="h-full w-full flex items-center justify-center text-gray-500">No orders available</div>;
	}

	return (
		<>
			<table className={`${styles.table} table-auto p-4 bg-white shadow-sm h-full`}>
