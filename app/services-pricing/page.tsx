...
const additionalServicesTabs: ("All" | "Document" | "Delivery" | "Creative")[] = [
	"All",
	"Document",
	"Delivery",
	"Creative",
...
const ServiceAndPricingPage = () => {
	...
	const [additionalServiceTab, setAdditionalServiceTab] = useState<"All" | "Document" | "Delivery" | "Creative">(
		"All"
	);
	...
	return (
		<>
			<div className="flex flex-col justify-center gap-4">
				...
				<div className="bg-white p-4 rounded-sm flex flex-col gap-5">
					...
					{currentTab === "servicePricing" ? (
															...
															<div className="flex gap-1">
																...
																{isEditing ? (
																	<input
																		...
																		value={`${
																			editedService[
																				field as keyof typeof editedService
																			]
																		}`}
																		onChange={(e) =>
						...
						<>
							<div className="flex justify-between">
								<div className="flex flex-col justify-center">
									<span className="text-black font-semibold text-xl">Additional Services</span>
									<span className="text-[#555555] font-normal text-base">
										Enable or disable additional services you offer
									</span>
								</div>
								<div className="border flex border-[#C9C9C9] rounded-[10px] gap-2.5 p-1">
									{additionalServicesTabs.map((label, index) => (
										<button
											...
											onClick={() => setAdditionalServiceTab(label)}>
											...
											<div className="flex items-center gap-4">
												<div>
													<div className="rounded-full flex justify-center items-center shadow shadow-[#06044B40]">
														<img
															src={`/AdditionalServices/${service.icon}`}
															alt={service.title}
															className="p-4"
														/>
													</div>
							...
							<div className="border border-[#BFDBFE] bg-[#EFF4FF] p-4 rounded flex items-start gap-4">
								<div className="py-2">
									<InfoIcon color="#2563EB" size={20} />
								</div>
								<div className="flex flex-col gap-2">
									<div>
										<p className="font-semibold text-[#1E40AF] text-base">Important Notice</p>
										<p className="font-normal text-base text-[#1D4ED8]">
											Need to set up more complex pricing rules or discounts? Contact our support
											team for assistance with custom pricing configurations.
										</p>
									</div>
									<div>
