...
const availableServices = ["Haircut", "Shaving", "Facial", "Massage", "Hair Coloring", "Manicure", "Pedicure"];
			...
			<div className="w-full max-w-6xl flex flex-col md:flex-row md:gap-4 lg:gap-8">
				<div className="flex flex-col space-y-8 flex-1">
					<div className="flex flex-col gap-2">
						...
						<p className="subHeading">Choose the printing services your business provides.</p>
					</div>
					<div className="flex flex-col gap-2">
							...
							{availableServices.map((service) => (
								<button
									...
									className={`serviceButton ${
										selectedServices.includes(service) ? "selected" : "notSelected"
									}`}>
									{service}
								</button>
							))}
